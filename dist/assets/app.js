...
`,p=`pixu:accent-color`,m=document.documentElement,h=[{value:`blue`,label:`Blue`,color:`#0072b2`},{value:`green`,label:`Green`,color:`#007a5a`},{value:`orange`,label:`Orange`,color:`#b94700`},{value:`purple`,label:`Purple`,color:`#6d55b8`},{value:`rose`,label:`Rose`,color:`#9b3d73`}],g=0;function _(){try{let e=window.localStorage.getItem(p);return h.some(t=>t.value===e)?e:`blue`}catch{return`blue`}}function v(e){try{window.localStorage.setItem(p,e)}catch{}}(class e extends HTMLElement{static{n(`accent-color-selector`,f),r(`accent-color-selector`,e)}connectedCallback(){if(this.dataset.ready===`true`)return;this.dataset.ready=`true`,this.setAttribute(`role`,`radiogroup`),this.setAttribute(`aria-label`,`Accent color`);let e=`accent-color-${g}`;g+=1;for(let t of h){let n=document.createElement(`label`);n.dataset.option=t.value,n.style.setProperty(`--swatch-color`,t.color),n.setAttribute(`aria-label`,t.label),n.innerHTML=`<input type="radio" name="${e}" value="${t.value}" ${_()===t.value?`checked`:``} /><span data-swatch aria-hidden="true"></span><span data-label>${t.label}</span>`,this.append(n)}this.addEventListener(`change`,this),m.dataset.accent=this.value}disconnectedCallback(){this.removeEventListener(`change`,this)}get value(){return this.querySelector(`input:checked`)?.value||`blue`}handleEvent(e){let t=e.target.closest(`input[type='radio']`);e.type!==`change`||!t||!this.contains(t)||(v(t.value),m.dataset.accent=t.value)}});var y=`@layer components {
  ...
  :root:is([data-reduce-motion="true"], [data-reduce-animations="true"]) {
    & display-preferences-popover {
...
`,b=`pixu:display-preferences`,x=[`75%`,`80%`,`90%`,`100%`,`110%`,`120%`,`125%`],S=[{description:`Zero radius across cards and controls.`,id:`square`,label:`Square`},{description:`The default rounded interface.`,id:`rounded`,label:`Rounded`},{description:`A softer silhouette with larger curves.`,id:`squircle`,label:`Squircle`}],C=[{attribute:`data-reduce-motion`,description:`Tone down movement-heavy interactions.`,label:`Reduce motion`,name:`reduceMotion`},{attribute:`data-reduce-animations`,description:`Minimize reveals, fades, and transitions.`,label:`Reduce animations`,name:`reduceAnimations`},{attribute:`data-reduce-transparency`,description:`Swap glass effects for solid surfaces.`,label:`Reduce transparency`,name:`reduceTransparency`},{attribute:`data-increase-contrast`,description:`Boost surface and text separation.`,label:`Increase contrast`,name:`increaseContrast`}],w=[{id:`avenir-humanist`,label:`Avenir Humanist`,stack:`"Avenir Next", Inter, "Segoe UI Variable Text", "Helvetica Neue", sans-serif`},{id:`editorial-serif`,label:`Editorial Serif`,stack:`"Iowan Old Style", "Palatino Linotype", "Book Antiqua", Palatino, Georgia, serif`},{id:`system-sans`,label:`System Sans`,stack:`system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif`},{id:`book-serif`,label:`Book Serif`,stack:`Baskerville, "Times New Roman", Georgia, serif`}],T=[{id:`inter-sans`,label:`Inter Sans`,stack:`Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif`},{id:`humanist-sans`,label:`Humanist Sans`,stack:`"Avenir Next", Inter, "Segoe UI Variable Text", "Helvetica Neue", sans-serif`},{id:`book-serif`,label:`Book Serif`,stack:`Georgia, Cambria, "Times New Roman", serif`},{id:`editorial-serif`,label:`Editorial Serif`,stack:`"Iowan Old Style", "Palatino Linotype", "Book Antiqua", Palatino, Georgia, serif`}],E=[{id:`plex-mono`,label:`Plex Mono`,stack:`"IBM Plex Mono", "SFMono-Regular", "Cascadia Code", Consolas, monospace`},{id:`system-mono`,label:`System Mono`,stack:`ui-monospace, "SFMono-Regular", Menlo, Consolas, monospace`},{id:`classic-mono`,label:`Classic Mono`,stack:`"Courier New", Courier, monospace`}],D={bodyFont:T,codeFont:E,headingFont:w},O=Object.freeze({bodyFont:`inter-sans`,codeFont:`plex-mono`,fontScale:`100%`,headingFont:`avenir-humanist`,increaseContrast:!1,radiusPreset:`rounded`,reduceAnimations:!1,reduceMotion:!1,reduceTransparency:!1}),k=typeof HTMLElement<`u`&&`showPopover`in HTMLElement.prototype,A=0;function j(){try{return window.localStorage}catch{return null}}function M(e,t){let n=D[e]||[];return n.find(e=>e.id===t)||n[0]}function ee(e){return S.find(t=>t.id===e)||S.find(e=>e.id===O.radiusPreset)}function N(e={}){let t=e&&typeof e==`object`?e:{};return{bodyFont:M(`bodyFont`,t.bodyFont).id,codeFont:M(`codeFont`,t.codeFont).id,fontScale:x.includes(t.fontScale)?t.fontScale:O.fontScale,headingFont:M(`headingFont`,t.headingFont).id,increaseContrast:t.increaseContrast===!0,radiusPreset:ee(t.radiusPreset).id,reduceAnimations:t.reduceAnimations===!0,reduceMotion:t.reduceMotion===!0,reduceTransparency:t.reduceTransparency===!0}}function P(){let e=j()?.getItem(b);if(!e)return{...O};try{return N(JSON.parse(e))}catch{return{...O}}}function te(e){let t=N(e);return j()?.setItem(b,JSON.stringify(t)),t}function ne(e,t,n){if(n){e.setAttribute(t,`true`);return}e.removeAttribute(t)}function F(e){let t=N(e);if(typeof document>`u`)return t;let n=document.documentElement;return n?(C.forEach(e=>{ne(n,e.attribute,t[e.name])}),t.fontScale===O.fontScale?n.style.removeProperty(`font-size`):n.style.fontSize=t.fontScale,n.style.setProperty(`--font-display`,M(`headingFont`,t.headingFont).stack),n.style.setProperty(`--font-body`,M(`bodyFont`,t.bodyFont).stack),n.style.setProperty(`--font-mono`,M(`codeFont`,t.codeFont).stack),n.setAttribute(`data-radius-preset`,t.radiusPreset),t):t}function I(e,t){return e.map(e=>{let n=e.id===t?` selected`:``;return`<option value="${e.id}"${n}>${e.label}</option>`}).join(``)}function L(e){return x.map(t=>`<option value="${t}"${t===e?` selected`:``}>${t}</option>`).join(``)}function R(e,t){return S.map(n=>{let r=n.id===t?` checked`:``,i=`${e}-radius-${n.id}`;return`
    ...
    `}).join(``)}function z(e,t){return C.map(n=>{let r=t[n.name]?` checked`:``,i=`${e}-${n.name}`;return`
      <div data-checkbox>
...
`;(class e extends HTMLElement{static{n(`skip-link`,V),r(`skip-link`,e)}connectedCallback(){this.dataset.ready!==`true`&&(this.dataset.ready=`true`,this.setAttribute(`role`,`link`),this.setAttribute(`tabindex`,`0`),this.textContent.trim()||(this.textContent=`Skip to content`),this._handleSkip=e=>{if(e.type!==`click`&&!(e.type===`keydown`&&e.key===`Enter`))return;let t=document.getElementById((this.getAttribute(`href`)||`#main`).slice(1));t&&(e.preventDefault(),t.tabIndex=-1,t.focus(),t.addEventListener(`blur`,()=>t.removeAttribute(`tabindex`),{once:!0}))},this.addEventListener(`click`,this._handleSkip),this.addEventListener(`keydown`,this._handleSkip))}disconnectedCallback(){this.removeEventListener(`click`,this._handleSkip),this.removeEventListener(`keydown`,this._handleSkip)}});var H=`@property --scroll-progress-value {
  syntax: "<number>";
  inherits: true;
  initial-value: 0;
}
...
`;function U(e){return Math.min(Math.max(e,0),1)}(class e extends HTMLElement{static{n(`scroll-progress`,H),r(`scroll-progress`,e)}connectedCallback(){this.dataset.ready!==`true`&&(this.dataset.ready=`true`,this.setAttribute(`aria-hidden`,`true`),this._currentProgress=0,this._targetProgress=0,this._frame=0,this._commitProgress=e=>{let t=U(e);this.style.setProperty(`--scroll-progress-value`,t.toFixed(4))},this._readTargetProgress=()=>{let e=document.documentElement.scrollHeight-window.innerHeight;return e>0?U(window.scrollY/e):0},this._shouldReduceMotion=()=>document.documentElement.hasAttribute(`data-reduce-motion`)||window.matchMedia?.(`(prefers-reduced-motion: reduce)`)?.matches===!0,this._stepProgress=()=>{let e=this._targetProgress-this._currentProgress;if(Math.abs(e)<=.001||this._shouldReduceMotion()){this._currentProgress=this._targetProgress,this._commitProgress(this._currentProgress),this._frame=0;return}this._currentProgress+=e*.18,this._commitProgress(this._currentProgress),this._frame=window.requestAnimationFrame(this._stepProgress)},this._updateProgress=()=>{if(this._targetProgress=this._readTargetProgress(),this._shouldReduceMotion()){this._currentProgress=this._targetProgress,this._commitProgress(this._currentProgress),this._frame&&=(window.cancelAnimationFrame(this._frame),0);return}this._frame||=window.requestAnimationFrame(this._stepProgress)},window.addEventListener(`scroll`,this._updateProgress,{passive:!0}),window.addEventListener(`resize`,this._updateProgress,{passive:!0}),this._updateProgress())}disconnectedCallback(){window.removeEventListener(`scroll`,this._updateProgress),window.removeEventListener(`resize`,this._updateProgress),this._frame&&=(window.cancelAnimationFrame(this._frame),0)}});var re=`@layer components {
  pointer-glow {
    position: fixed;
...
`;(class e extends HTMLElement{static{n(`pointer-glow`,re),r(`pointer-glow`,e)}connectedCallback(){this.dataset.ready!==`true`&&(this.dataset.ready=`true`,this.setAttribute(`aria-hidden`,`true`),!window.matchMedia(`(pointer: coarse)`).matches&&(this._handleMove=e=>{this.style.setProperty(`--x`,`${e.clientX}px`),this.style.setProperty(`--y`,`${e.clientY}px`)},window.addEventListener(`pointermove`,this._handleMove,{passive:!0})))}disconnectedCallback(){window.removeEventListener(`pointermove`,this._handleMove)}});function W(){}function ie(e={}){let t=e.window,n=e.document||t?.document||globalThis.document,r=e.header||n?.querySelector(`[data-header]`)||null,i=e.nav||n?.querySelector(`[data-nav]`)||null,a=e.navLinks||Array.from(n?.querySelectorAll(`[data-nav-link]`)||[]),o=e.sections||Array.from(n?.querySelectorAll(`main > section[id]`)||[]),s=e.mobileQuery||(typeof t?.matchMedia==`function`?t.matchMedia(`(max-width: 992px)`):{matches:!1}),c=e.closeNavigation||W;if(!t||!i||!a.length||!o.length)return{destroy:W};let l=typeof t.requestAnimationFrame==`function`?t.requestAnimationFrame.bind(t):e=>t.setTimeout(e,16),u=typeof t.cancelAnimationFrame==`function`?t.cancelAnimationFrame.bind(t):t.clearTimeout.bind(t),d=``,f,p=0,m=``,h=0,g=0;function _(){return Math.ceil((r?.getBoundingClientRect().height||0)+24)}function v(e){!e||e===d||(d=e,a.forEach(t=>{let n=t.getAttribute(`href`)===`#${e}`;t.toggleAttribute(`aria-current`,n),t.dataset.active=String(n)}))}function y(){return _()+16}function b(){let e=y(),r=t.innerHeight||n?.documentElement?.clientHeight||0,i=o.map(t=>{let n=t.getBoundingClientRect(),i=Math.max(n.top,0),a=Math.min(n.bottom,r),o=Math.max(0,a-i);return{anchorDistance:Math.abs(n.top-e),containsAnchor:n.top<=e&&n.bottom>e,id:t.id,rect:n,visibleRatio:n.height>0?o/n.height:0}}).filter(({rect:e})=>e.height>0),a=(e,t)=>t.visibleRatio-e.visibleRatio||e.anchorDistance-t.anchorDistance,s=i.filter(({containsAnchor:e})=>e).sort(a);return s[0]?s[0].id:i.filter(({rect:e})=>e.bottom>0&&e.top<r).sort(a)[0]?.id||o[0]?.id||``}function x(){m=``,h&&=(u(h),0)}function S(e){let t=n.getElementById(e);if(!t)return!0;let r=t.getBoundingClientRect(),i=y();return r.top<=i+2&&r.bottom>i}function C(){if(p=0,m){if(!S(m)){v(m);return}x()}v(b())}function w(){p||=l(()=>{C()})}function T(e){x(),m=e,v(e);let t=180,n=()=>{if(!m){h=0;return}if(w(),--t,t<=0){x(),w();return}h=l(n)};h=l(n)}function E(){f?.disconnect(),f=new t.IntersectionObserver(()=>{w()},{rootMargin:`-${_()}px 0px -30% 0px`,threshold:[0,.15,.3,.6,1]}),o.forEach(e=>{f.observe(e)}),w()}function D(){g||=l(()=>{g=0,E()})}function O(){x(),v(b())}function k(){D(),w()}function A(e){let r=e.target.closest(`a[href^="#"]`);if(!r)return;let i=n.getElementById(r.getAttribute(`href`).slice(1));if(!i)return;e.preventDefault();let a=Math.max(i.getBoundingClientRect().top+t.scrollY-_(),0),o=typeof t.matchMedia==`function`&&t.matchMedia(`(prefers-reduced-motion: reduce)`).matches;T(i.id),t.history?.pushState?.(null,``,`#${i.id}`),t.scrollTo({top:a,behavior:o?`auto`:`smooth`}),w(),s.matches&&c()}return i.addEventListener(`click`,A),typeof t.IntersectionObserver==`function`?(E(),t.addEventListener(`resize`,k,{passive:!0})):(t.addEventListener(`scroll`,O,{passive:!0}),t.addEventListener(`resize`,O,{passive:!0}),O()),{destroy(){i.removeEventListener(`click`,A),t.removeEventListener(`scroll`,O),t.removeEventListener(`resize`,O),t.removeEventListener(`resize`,k),f?.disconnect(),p&&=(u(p),0),g&&=(u(g),0),x()}}}var ae=typeof HTMLElement<`u`&&`showPopover`in HTMLElement.prototype,G=typeof window<`u`?window.matchMedia(`(max-width: 639px)`):null;function oe(){let e=Array.from(document.querySelectorAll(`[data-item-detail-trigger]`)),t=Array.from(document.querySelectorAll(`[data-item-detail="talk"]`));if(!e.length&&!t.length)return;if(!ae){document.documentElement.dataset.popoverFallback=`inline`;return}let n=()=>{let n=G?.matches!==!1;t.forEach(e=>{if(n){e.setAttribute(`popover`,`auto`);return}e.matches(`:popover-open`)&&e.hidePopover(),e.removeAttribute(`popover`),e.dataset.open=`false`}),e.forEach(e=>{e.dataset.detailKind===`talk`&&!n&&e.setAttribute(`aria-expanded`,`false`)})};n(),G?.addEventListener(`change`,n),e.forEach(e=>{let t=e.getAttribute(`popovertarget`),n=t?document.getElementById(t):null;if(!n)return;let r=!1;e.addEventListener(`click`,()=>{r=!0}),n.addEventListener(`toggle`,t=>{let i=t.newState===`open`;n.dataset.open=String(i),e.setAttribute(`aria-expanded`,String(i)),!i&&r&&(e.focus(),r=!1)})})}var K=document.documentElement,se=document.querySelector(`[data-header]`),q=document.querySelector(`[data-nav]`),J=document.querySelector(`[data-nav-toggle]`),Y=document.querySelector(`[data-live-region]`),X=window.matchMedia(`(max-width: 992px)`),Z=``;function ce(e){Y&&(Y.textContent=``,window.requestAnimationFrame(()=>{Y.textContent=e}))}function Q(e,t={}){if(!(!q||!J)){if(!X.matches){K.dataset.navState=`open`,J.setAttribute(`aria-expanded`,`false`),q.inert=!1;return}K.dataset.navState=e?`open`:`closed`,J.setAttribute(`aria-expanded`,String(e)),q.inert=!e,t.focusToggle&&J.focus(),t.announce&&ce(e?`Navigation opened`:`Navigation closed`)}}function $(){let e=X.matches?`mobile`:`desktop`;K.dataset.navMode=e,e!==Z&&Q(e===`desktop`),Z=e}function le(){let e=Array.from(document.querySelectorAll(`[data-reveal]`));if(!e.length)return;K.dataset.revealReady=`true`;let t=typeof CSS<`u`&&typeof CSS.supports==`function`&&CSS.supports(`animation-timeline: view(block)`),n=new Set(e),r=0,i;function a(e){e.dataset.visible!==`true`&&(e.dataset.visible=`true`,n.delete(e),i?.unobserve(e))}function o(e){let t=e.getBoundingClientRect(),n=window.innerHeight||document.documentElement.clientHeight||0;return t.top<=n*.9&&t.bottom>=n*.08}function s(){window.removeEventListener(`scroll`,l),window.removeEventListener(`resize`,l),i?.disconnect()}function c(){r=0,n.forEach(e=>{o(e)&&a(e)}),n.size||s()}function l(){r||=window.requestAnimationFrame(c)}if(e.forEach((e,t)=>{e.style.setProperty(`--reveal-order`,String(t%6))}),t){e.forEach(a);return}if(!(`IntersectionObserver`in window)){e.forEach(a);return}i=new IntersectionObserver(e=>{e.forEach(e=>{!e.isIntersecting&&!o(e.target)||a(e.target)}),n.size||s()},{rootMargin:`0px 0px -12% 0px`,threshold:[0,.12]}),e.forEach(e=>{if(o(e)){a(e);return}i.observe(e)}),window.addEventListener(`scroll`,l,{passive:!0}),window.addEventListener(`resize`,l,{passive:!0}),l()}function ue(){document.querySelectorAll(`a[target="_blank"]`).forEach(e=>{let t=new Set(String(e.getAttribute(`rel`)||``).split(/\s+/).filter(Boolean));t.add(`noopener`),t.add(`noreferrer`),e.setAttribute(`rel`,Array.from(t).join(` `))})}J?.addEventListener(`click`,()=>{Q(K.dataset.navState!==`open`,{announce:!0})}),document.addEventListener(`keydown`,e=>{e.key!==`Escape`||!X.matches||K.dataset.navState!==`open`||(e.preventDefault(),Q(!1,{focusToggle:!0,announce:!0}))}),window.addEventListener(`resize`,()=>{$()},{passive:!0}),typeof X.addEventListener==`function`?X.addEventListener(`change`,$):typeof X.addListener==`function`&&X.addListener($),$(),ue(),le(),ie({closeNavigation:()=>{Q(!1)},header:se,mobileQuery:X,nav:q,window}),oe();