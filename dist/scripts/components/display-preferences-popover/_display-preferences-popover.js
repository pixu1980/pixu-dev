...
const ACCESSIBILITY_OPTIONS = [
  {
    ...
    description: "Tone down movement-heavy interactions, reveals, fades, and transitions.",
    label: "Reduce motion",
    name: "reduceMotion",
  },
  {
...
function normalizePreferences(preferences = {}) {
  ...
  return {
    ...
    // Backward compatibility: old saved "reduceAnimations" now maps to reduceMotion.
...
export function applyPreferencesToDocument(preferences) {
  ...
  // Remove legacy attribute once preferences are reapplied.
