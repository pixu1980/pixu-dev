<template>
  <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="interests">
    <div class="w-100">
      ...
      <p>
        Apart from being a frontend developer, I enjoy most of my time being outdoors. In the winter, I like to go ski
        and sometimes go ice fishing. During the summer, I enjoy mountain biking, running, and fishing.
      </p>
      <p class="mb-0">
